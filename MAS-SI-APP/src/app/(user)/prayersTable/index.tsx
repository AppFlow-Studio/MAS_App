              ...
              <>
                ...
                <View className='flex flex-row w-[95%] my-2 space-x-2 px-1 self-center'>
                  <ImageBackground source={require('@/assets/images/TaraweehCard.png')}
                    style={{
                      height: 130, width: '50%', shadowColor: 'rgba(0, 0, 0, 0.25)', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 1, shadowRadius: 4, elevation: 5
                ...
                <ImageBackground
                  ...
                  style={{
                    width: '95%', height: 60, borderRadius: 15, alignSelf: 'center', shadowColor: 'rgba(0, 0, 0, 0.25)', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 1, shadowRadius: 4, elevation: 5
                  }}
