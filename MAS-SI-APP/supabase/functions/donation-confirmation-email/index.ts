      ...
      const html = generateEmailHtml({
        ...
        sections: [
          ...
          { type: 'details-table', rows: [
            ...
            { label: 'Organization', value: 'MAS Staten Island Center' },
            { label: 'EIN', value: '93-3443674' },
          ]},
          { type: 'text', content: 'MAS Staten Island Center is a registered 501(c)(3) charitable religious organization (EIN: 93-3443674). Your donation may be tax-deductible to the extent allowed by law. No goods or services were provided in exchange for this contribution. Please retain this receipt for your tax records.' },
          ...
          { type: 'text', content: 'If you have any questions about your donation or would like to learn more about how your contribution is making an impact, please do not hesitate to reach out to us at Admin@massic.org.' },
        ],
